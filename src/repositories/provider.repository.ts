...
import {Provider, ProviderRelations, Material, Reservation, Income} from '../models';
...
> {
  ...
  public readonly incomes: HasManyThroughRepositoryFactory<Material, typeof Material.prototype.id,
          Income,
          typeof Provider.prototype.id
        >;

  constructor(
    @inject('datasources.Mongo') dataSource: MongoDataSource, @repository.getter('ReservationRepository') protected reservationRepositoryGetter: Getter<ReservationRepository>, @repository.getter('MaterialRepository') protected materialRepositoryGetter: Getter<MaterialRepository>, @repository.getter('IncomeRepository') protected incomeRepositoryGetter: Getter<IncomeRepository>,
  ) {
    super(Provider, dataSource);
    this.incomes = this.createHasManyThroughRepositoryFactoryFor('incomes', materialRepositoryGetter, incomeRepositoryGetter,);
